...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $account = "group"; // Set the account to "group"
...
<head>
    ...
    <title>Barangay GroupChat</title>
...
<body>
    <div class="container">
        ...
        <form action="group.php" method="post" class="form">
