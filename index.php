        ...
        <div class="container">
            <form method="post" onsubmit="return validateForm();" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <label class="remember-me">
                    ...
                    <span class="forgot-password"><a href="forgot.php">Forgot Password?</a></span>
                </label>
            ...
            <div class="create-account-text">
                <p>Don't have an account? <a href="account.php" class="create-account-link">Create an account</a></p>
            </div>
