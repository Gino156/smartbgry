...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $isAdmin = isset($_POST['is_admin']) ? $_POST['is_admin'] : 0; // Default to 0 if not provided

    // Prepare the statement to prevent SQL injection
    $stmt = $conn->prepare("INSERT INTO admin (email, password, fullname, username, is_admin) VALUES (?, ?, ?, ?, ?)");
    // Bind parameters
    $stmt->bind_param("sssss", $email, $password, $fullname, $username, $isAdmin);
