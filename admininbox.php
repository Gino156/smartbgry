        ...
        <div class="profile-info">
           ...
           <nav>
            <ul>
                ...
                <li><a href="admininbox.php"><img src="inbox.png" alt="Inbox" width="20" height="20">Inbox</a></li>
                <li><a href="general.php"><img src="arrow.png" alt="Transactions" width="20" height="20">All Transactions</a></li>
                <li><a href="#"><img src="ticket.png" alt="Tickets" width="20" height="20">Tickets</a></li>
                <li><a href="index.php"><img src="logout.png" alt="Log out" width="20" height="20">Log out</a></li>
            </ul>
        </nav>
    </div>
