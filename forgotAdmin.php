...
if (isset($_POST['email']) && isset($_POST['new_password'])) {
    ...
    try {
        $stmt = $pdo->prepare("UPDATE admin SET password = :newPassword WHERE email = :desiredEmail");
...
<body>
    ...
    <div class="container">
        <form action="forgotAdmin.php" method="post" onsubmit="return validateForm();">
        ...
        <footer class="footer">
            <a href="admin_dashboard.php">Return to Login Page</a>
        </footer>
    </div>
